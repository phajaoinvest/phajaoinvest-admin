...
export default function InternationalStockAccountDetailPage() {
    ...
    const handleApprove = async () => {
        ...
        try {
            ...
            router.push('/dashboard/services/international-stock-accounts')
        } catch (err) {
            ...
            <div className="flex items-center justify-between">
                <div className="space-y-1">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">International Stock Account Application</h1>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-semibold capitalize">
                                {detail.service.active ? 'Active' : 'Inactive'}
                            </p>
                        </div>
                    </div>
                </Card>
                    ...
                    <Card className="p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-medium">International Stock Account</p>
                            </div>
                            <div>
